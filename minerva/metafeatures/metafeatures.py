...
# These took over 24h to complete on the biggest dataset.
# Evidently they're not suitable to quickly asses datasets.
_EXPENSIVE_ONES = (
...
def calculate_metafeatures(name: str, x: np.ndarray, y: np.ndarray):
    return calculate_all_metafeatures(x, y, [False] * x.shape[-1], name, dont_calculate=_EXPENSIVE_ONES)
